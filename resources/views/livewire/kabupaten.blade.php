    ...
    <div class="card radius-10">
        <div class="card-body">
            <div class="d-flex align-items-center">
                <div>
                    <a href="{{ route('kabupaten.create') }}" class="btn btn-primary btn-sm">Tambah</a>
                </div>
                <div class="ms-auto">
                        ...
                        @if (count($query) > 0)
                            @foreach ($query as $row)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('kabupaten.edit', $row->id) }}" class="text-primary"><i
                                                style="font-size: 19px" class="bx bx-message-square-edit"></i></a>
                                        <a href="{{ route('kabupaten.destroy', $row->id) }}"
                                        ...
                                        <form action="{{ route('kabupaten.destroy', $row->id) }}" method="post"
