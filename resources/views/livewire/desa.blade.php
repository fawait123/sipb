    ...
    <div class="card radius-10">
        <div class="card-body">
            <div class="d-flex align-items-center">
                <div>
                    <a href="{{ route('desa.create') }}" class="btn btn-primary btn-sm">Tambah</a>
                </div>
                <div class="ms-auto">
                        ...
                        @if (count($query) > 0)
                            @foreach ($query as $row)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('desa.edit', $row->id) }}" class="text-primary"><i
                                                style="font-size: 19px" class="bx bx-message-square-edit"></i></a>
                                        <a href="{{ route('desa.destroy', $row->id) }}"
                                        ...
                                        <form action="{{ route('desa.destroy', $row->id) }}" method="post"
